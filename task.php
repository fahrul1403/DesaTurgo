        ...
        <main>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>Persiapkan 3 Kamar</td>
                        <td>Ada 3 booking untuk bulan depan</td>
                        <td>2024-12-18</td>
                        <td>2024-11-21 00:24:39</td>
                        <td>Done</td>
                        <td><button class="btn-add"
                                onclick="showModal('Persiapkan 3 Kamar', './img/kamar.png')">View</button>
                        </td>
                    </tr>
            ...
            <div class="modal" id="modal">
                <h2 id="modalTitle"></h2>
                <img id="modalImage" src="./img/kamar.png" alt="Task Image">
